...
WITH [Waits] AS
    (SELECT
        ...
        [wait_time_ms] / 1000.0 AS [Wait Seconds],
        ([wait_time_ms] - [signal_wait_time_ms]) / 1000.0 AS [Resource Seconds],
        [signal_wait_time_ms] / 1000.0 AS [Signal Seconds],
...
SELECT
    ...
    CAST (MAX ([W1].[Wait Seconds]) AS DECIMAL (16,2)) AS [Wait Seconds],
    CAST (MAX ([W1].[Resource Seconds]) AS DECIMAL (16,2)) AS [Resource Seconds],
    CAST (MAX ([W1].[Signal Seconds]) AS DECIMAL (16,2)) AS [Signal Seconds],
