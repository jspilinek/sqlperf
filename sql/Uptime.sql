...
SELECT FORMAT(GETDATE() AT TIME ZONE 'ENTER_TIME_ZONE', 'ENTER_DATE_FORMAT') AS CurrentTime,
FORMAT(@login_time AT TIME ZONE 'ENTER_TIME_ZONE', 'ENTER_DATE_FORMAT') AS LastStartup,
