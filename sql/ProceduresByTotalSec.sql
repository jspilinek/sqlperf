SELECT TOP 25 
  ...
  FORMAT(ps.last_execution_time AT TIME ZONE 'ENTER_TIME_ZONE', 'ENTER_DATE_FORMAT') AS last_execution_time,
  FORMAT(ps.cached_time AT TIME ZONE 'ENTER_TIME_ZONE', 'ENTER_DATE_FORMAT') AS cached_time
